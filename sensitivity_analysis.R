...
# inputs
random_sample_1 <- objeto_netlogo@simdesign@simobject[[1]][["X1"]]
random_sample_2 <- objeto_netlogo@simdesign@simobject[[1]][["X2"]]
experiment_design <- objeto_netlogo@simdesign@simobject[[1]][["X"]]
...
sensitivity_assess <- sobol(model = NULL, X1 = random_sample_1, X2 = random_sample_2, order = 2, nboot = 1000) 
...
objeto_netlogo@simdesign@simobject[[1]][["X"]]
all.equal(crossings_x$X, sobol1000samples@simdesign@simobject[[1]][["X"]])
