...
sensi_together <- sensi_assess + sensi_cross + plot_layout(ncol = 2, guides = "collect") & 
  theme(legend.position = 'bottom', legend.key.size = unit(1, 'cm'), legend.text = element_markdown(size = 14)) 

ggsave(sensi_together, filename = here("imagens", "sensitivity_configuration.png"), 
       dpi = 600, width = 7000, height = 3000, unit = "px")
