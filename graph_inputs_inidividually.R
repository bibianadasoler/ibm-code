...
habitat_aggreg <- assess_prop_habitat_amount + assess_perm_habitat_amount + assess_percep_habitat_amount + assess_vision_habitat_amount +
  plot_layout(ncol = 4) + plot_annotation(title = 'Habitat amount submodel', theme = theme(plot.title = element_text(size = 12, vjust = 1)))
config_aggreg <- assess_scenarios_config + assess_perm_config + assess_percep_config + assess_vision_config +
  plot_layout(ncol = 4) + plot_annotation(title = 'Configuration submodel', theme = theme(plot.title = element_text(size = 12, vjust = 1)))
...
ggsave(all_together, filename = here::here("imagens", "inputs_individually.png"), 
